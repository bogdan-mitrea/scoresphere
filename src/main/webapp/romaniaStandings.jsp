                ...
                <table class="standings-table">
                    ...
                    <%
                        ...
                        try {
                            ...
                            String sql = "SELECT teamName, matchesPlayed, points FROM teams WHERE nationality='Romania' ORDER BY points DESC";
                            ...
                            for (Map<String, Object> team : teams) {
                                ...
                                if (rank == 1) {
                                    rowClass = "top-four";
                                } else if (rank == 2 || rank == 13 || rank == 14) {
                                    rowClass = "fifth-sixth";
                                } else if (rank == 3 || rank == 7 || rank == 8) {
                                    rowClass = "seventh";
                                } else if (rank == 15 || rank == 16) {
                ...
                <%
                    try {
                        ...
                        String sql = "SELECT s.homeTeam, s.awayTeam, s.matchDate, s.matchTime, s.homeScore, s.awayScore, s.isLive " +
                                ...
                                "WHERE t1.nationality = 'Romania' AND t2.nationality = 'Romania' " +
