                ...
                <table class="standings-table">
                    ...
                    <%
                        ...
                        try {
                            ...
                            String sql = "SELECT teamName, matchesPlayed, points FROM teams WHERE nationality='France' ORDER BY points DESC";
                ...
                <%
                    try {
                        ...
                        String sql = "SELECT s.homeTeam, s.awayTeam, s.matchDate, s.matchTime, s.homeScore, s.awayScore, s.isLive " +
                                ...
                                "WHERE t1.nationality = 'France' AND t2.nationality = 'France' " +
